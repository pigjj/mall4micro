...
type MallSysUser struct {
	cm.MallBase
	Username string `gorm:"column:username;size:50;comment:用户名;not null;index" json:"username"`
	Password string `gorm:"column:password;size:100;comment:密码;not null" json:"password"`
	Email    string `gorm:"column:email;size:50;comment:邮箱;default:null" json:"email"`
	Mobile   string `gorm:"column:mobile;size:50;comment:手机号;default:null" json:"mobile"`
