...
type RpcUserInfoReply struct {
	...
	SaltStr  string           `protobuf:"bytes,8,opt,name=salt_str,json=saltStr,proto3" json:"salt_str,omitempty"`
}
...
func (x *RpcUserInfoReply) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_mall4micro_user_protos_user_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xdc, 0x01, 0x0a, 0x10, 0x52,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19,
	0x0a, 0x08, 0x73, 0x61, 0x6c, 0x74, 0x5f, 0x73, 0x74, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
